...
class FluvioConnector(QObject):
    connected = pyqtSignal(object, object)  # (Fluvio instance, producers dict)
...
class GreenhouseSimulator(QWidget):
    def __init__(self):
        ...
        self.profile_status = QLabel("🔴 Not Connected")
        ...
        # Start Fluvio connector
        self.fluvio_connector = FluvioConnector()
        self.fluvio_connector.connected.connect(self.set_fluvio)
        self.fluvio_connector.status_update.connect(self.update_profile_status)
    ...
    def setup_header(self):
        ...
        self.profile_status.setStyleSheet("font-size: 14px; font-weight: bold; color: green;")

        header.addWidget(title)
        header.addStretch()
        header.addWidget(self.profile_status)
    ...
    def set_fluvio(self, fluvio, producers):
        ...
        # Start listening for device control
